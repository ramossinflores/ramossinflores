...
class Emele:
    ...
    def __init__(self):
        ...
        self.daily = ['Linux', 'Windows', 'Active Directory', 'Ansible', 'Bash', 'PowerShell']
        self.focus = ['Network Security', 'IAM', 'Security Analysis']
...
<ul>
  <li><strong>Administradora de sistemas</strong> en entorno empresarial 24/7 (banca)</li>
  <li>Especializándome en seguridad en redes</li>
  <li>Automatizando lo repetitivo con Python, Bash y Ansible</li>
</ul>

---

<h2>Especialización actual</h2>
<p>
Cursando el <strong>Curso de Especialización en Ciberseguridad en Entornos de las TI</strong> (C.P.I.F.P. Alan Turing, Granada).
Fondo de <strong>administración de sistemas</strong> en producción real: monitorización, gestión de Active Directory, parcheo de Windows y Linux, y documentación de incidencias. Ahora orientándome hacia <strong>seguridad de redes</strong>.
</p>
...
<h3>Administración y Automatización</h3>
<p>
<img src="https://img.shields.io/badge/Active%20Directory-0078D6?style=flat&logo=windows&logoColor=white">  
...
<img src="https://img.shields.io/badge/Snort-IDS-D9411E?style=flat&logo=snort&logoColor=white">  
<img src="https://img.shields.io/badge/ELK-SIEM-005571?style=flat&logo=elastic&logoColor=white">  
<img src="https://img.shields.io/badge/Gitleaks-Secret%20Scanning-2B2B2B?style=flat&logo=git&logoColor=white">  
<img src="https://img.shields.io/badge/GPG-Commit%20Signing-0093DD?style=flat&logo=gnuprivacyguard&logoColor=white">  
</p>
...
<p>
<a href="https://linkedin.com/in/emele-ramos-granados"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white"></a>
</p>
```python
class Emele:
